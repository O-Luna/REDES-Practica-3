...
utilities/%.o: ../utilities/%.S utilities/subdir.mk
	...
	arm-none-eabi-gcc -c -x assembler-with-cpp -D__NEWLIB__ -I"C:\Embebidosk64\WORKSPACE_REDES\frdmrw612_wifi_webconfig\source" -I"C:\Embebidosk64\WORKSPACE_REDES\frdmrw612_wifi_webconfig\freertos\freertos-kernel\include" -I"C:\Embebidosk64\WORKSPACE_REDES\frdmrw612_wifi_webconfig\board" -g3 -gdwarf-4 -mcpu=cortex-m33+nodsp -mfpu=fpv5-sp-d16 -mfloat-abi=hard -mthumb -D__NEWLIB__ -specs=nano.specs -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
