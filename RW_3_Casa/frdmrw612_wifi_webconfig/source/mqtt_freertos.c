...
#include "board.h"
#include "fsl_gpio.h"
#include "component/silicon_id/fsl_silicon_id.h"
...
{
    static const char *topics[] = {"hoa/Casa/Mascota", "hoa/Casa/Candado"};
    int qos[]                   = {0, 1};
    err_t err;
    int i;
...
static void publish_movement(void *ctx)
{
    ...
    static const char *message = "alguien";
