...
C_SRCS += \
../source/Drivers/MQTT/fsl_silicon_id.c \
../source/Drivers/MQTT/mqtt_freertos.c 

C_DEPS += \
./source/Drivers/MQTT/fsl_silicon_id.d \
./source/Drivers/MQTT/mqtt_freertos.d 

OBJS += \
./source/Drivers/MQTT/fsl_silicon_id.o \
./source/Drivers/MQTT/mqtt_freertos.o 


# Each subdirectory must supply rules for building sources it contributes
source/Drivers/MQTT/%.o: ../source/Drivers/MQTT/%.c source/Drivers/MQTT/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-Drivers-2f-MQTT

clean-source-2f-Drivers-2f-MQTT:
	-$(RM) ./source/Drivers/MQTT/fsl_silicon_id.d ./source/Drivers/MQTT/fsl_silicon_id.o ./source/Drivers/MQTT/mqtt_freertos.d ./source/Drivers/MQTT/mqtt_freertos.o

.PHONY: clean-source-2f-Drivers-2f-MQTT
